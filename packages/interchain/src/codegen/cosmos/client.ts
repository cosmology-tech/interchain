...
import * as cosmosAccountsV1TxRegistry from "./accounts/v1/tx.registry";
...
import * as cosmosAccountsV1TxAmino from "./accounts/v1/tx.amino";
...
export const cosmosAminoConverters = {
  ...cosmosAccountsV1TxAmino.AminoConverter,
