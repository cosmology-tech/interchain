...
export const StoreCodeAuthorization = {
  ...
  fromSDK(object: StoreCodeAuthorizationSDKType): StoreCodeAuthorization {
    return {
      grants: Array.isArray(object?.grants) ? object.grants.map((e: any) => CodeGrant.fromSDK(e)) : []
    };
  },
  toSDK(message: StoreCodeAuthorization): StoreCodeAuthorizationSDKType {
    const obj: any = {};
    if (message.grants) {
      obj.grants = message.grants.map(e => e ? CodeGrant.toSDK(e) : undefined);
    } else {
      obj.grants = [];
    }
    return obj;
...
export const CodeGrant = {
  ...
  fromSDK(object: CodeGrantSDKType): CodeGrant {
    return {
  ...
  toSDK(message: CodeGrant): CodeGrantSDKType {
    const obj: any = {};
