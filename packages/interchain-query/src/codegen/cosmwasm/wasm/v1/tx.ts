...
export const MsgAddCodeUploadParamsAddresses = {
  ...
  fromSDK(object: MsgAddCodeUploadParamsAddressesSDKType): MsgAddCodeUploadParamsAddresses {
    return {
      authority: object?.authority,
      addresses: Array.isArray(object?.addresses) ? object.addresses.map((e: any) => e) : []
    };
  },
  toSDK(message: MsgAddCodeUploadParamsAddresses): MsgAddCodeUploadParamsAddressesSDKType {
    const obj: any = {};
    obj.authority = message.authority;
    if (message.addresses) {
      obj.addresses = message.addresses.map(e => e);
...
export const MsgAddCodeUploadParamsAddressesResponse = {
  ...
  fromSDK(_: MsgAddCodeUploadParamsAddressesResponseSDKType): MsgAddCodeUploadParamsAddressesResponse {
    return {};
  },
  toSDK(_: MsgAddCodeUploadParamsAddressesResponse): MsgAddCodeUploadParamsAddressesResponseSDKType {
    const obj: any = {};
    return obj;
  },
...
export const MsgRemoveCodeUploadParamsAddresses = {
  ...
  fromSDK(object: MsgRemoveCodeUploadParamsAddressesSDKType): MsgRemoveCodeUploadParamsAddresses {
    return {
      authority: object?.authority,
      addresses: Array.isArray(object?.addresses) ? object.addresses.map((e: any) => e) : []
    };
  },
  toSDK(message: MsgRemoveCodeUploadParamsAddresses): MsgRemoveCodeUploadParamsAddressesSDKType {
    const obj: any = {};
    obj.authority = message.authority;
    if (message.addresses) {
      obj.addresses = message.addresses.map(e => e);
...
export const MsgRemoveCodeUploadParamsAddressesResponse = {
  ...
  fromSDK(_: MsgRemoveCodeUploadParamsAddressesResponseSDKType): MsgRemoveCodeUploadParamsAddressesResponse {
    return {};
  },
  toSDK(_: MsgRemoveCodeUploadParamsAddressesResponse): MsgRemoveCodeUploadParamsAddressesResponseSDKType {
    const obj: any = {};
    return obj;
  },
...
export const MsgStoreAndMigrateContract = {
  ...
  fromSDK(object: MsgStoreAndMigrateContractSDKType): MsgStoreAndMigrateContract {
    return {
      authority: object?.authority,
      wasmByteCode: object?.wasm_byte_code,
      instantiatePermission: object.instantiate_permission ? AccessConfig.fromSDK(object.instantiate_permission) : undefined,
  ...
  toSDK(message: MsgStoreAndMigrateContract): MsgStoreAndMigrateContractSDKType {
    const obj: any = {};
    obj.authority = message.authority;
    obj.wasm_byte_code = message.wasmByteCode;
    message.instantiatePermission !== undefined && (obj.instantiate_permission = message.instantiatePermission ? AccessConfig.toSDK(message.instantiatePermission) : undefined);
...
export const MsgStoreAndMigrateContractResponse = {
  ...
  fromSDK(object: MsgStoreAndMigrateContractResponseSDKType): MsgStoreAndMigrateContractResponse {
    return {
      codeId: object?.code_id,
      checksum: object?.checksum,
      data: object?.data
  ...
  toSDK(message: MsgStoreAndMigrateContractResponse): MsgStoreAndMigrateContractResponseSDKType {
    const obj: any = {};
    obj.code_id = message.codeId;
    obj.checksum = message.checksum;
    obj.data = message.data;
